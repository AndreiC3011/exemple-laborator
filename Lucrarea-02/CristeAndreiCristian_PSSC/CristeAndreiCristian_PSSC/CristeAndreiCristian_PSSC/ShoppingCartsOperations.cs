...
namespace CristeAndreiCristian_PSSC
{
    ...
    {
        public static IShoppingCarts ValidateShoppingCarts(Func<PCode, bool> checkProductExists, EmptyShoppingCarts shoppingCarts)
        {
            ...
            {
                if (!PCode.TryParse(emptyShoppingCart.productCode, out PCode productCode))
                {
